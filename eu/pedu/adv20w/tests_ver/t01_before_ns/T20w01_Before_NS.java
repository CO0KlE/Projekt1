package eu.pedu.adv20w.tests_ver.t01_before_ns;
...
/*******************************************************************************
 * Instance třídy {@code T20w01_Before_NS} testují hru bez modifikací
 * vytvořenou podle zadání ze zimního semestru 2020.
 *
 * @author  Rudolf PECINOVSKÝ
 * @version 2020-Winter
 */
public class T20w01_Before_NS
     extends ASolutionTester
{
//\CC== CLASS CONSTANTS (CONSTANT CLASS/STATIC ATTRIBUTES/FIELDS) ==============

    /** Identifikátor testovaného zadání. */
    public static final String TEST_ID = "20w01";

    /** Popis požadované modifikace. */
    public static final String DESCRIPTION =
      "Hra podle původního zadání, ale ještě bez nestandardních akcí";
//
...
//\MM== MAIN METHOD ============================================================
    ...
    {
        T20w01_Before_NS tester = new T20w01_Before_NS();
        IGameFactory factory = new
            eu.pedu.adv20w.demo_ck.v01_before_ns.CK_Factory
