...
/*******************************************************************************
 * Instance interfejsu {@code IGame} je jedináček mající na starosti
 * řízení hry a komunikaci s uživatelským rozhraním.
...
//\CC== CLASS (STATIC) CONSTANTS ===============================================
    ...
    /** Základní omezení vytvářených her. */
    Limits LIMITS = new Limits(12, //Minimální počet kroků scénáře HAPPY
                                ...
                                4);//Minimální počet vlastních akcí
