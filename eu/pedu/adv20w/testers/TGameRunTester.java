...
//\IM== INSTANCE REMAINING NON-PRIVATE METHODS =================================
     ...
     */
    public void executeScenario(IScenario scenario)
    {
        prf("\n########## Tested scenarion: ##########\n%s\n"
            + "########################################\n",
            scenario);
...
//\IP== INSTANCE PRIVATE AND AUXILIARY METHODS =================================
     ...
     */
    private String header(IScenario scenario)
    {
        IGame  game = gameSummary.game;
        String text = N_HASHES
             + "\n##### Author:     " + factory.authorString()
     ...
     */
    private void updateGameSummary(IScenario scenario, Throwable throwable)
    {
     ...
     */
    private void verifyScenarioStep(IScenario scenario, ScenarioStep step,
                                    boolean theLast)
    {
