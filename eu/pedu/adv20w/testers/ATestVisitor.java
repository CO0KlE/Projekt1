...
//\IC== INSTANCE CONSTANTS (CONSTANT INSTANCE ATTRIBUTES/FIELDS) ===============
    ...
    protected final IGameFactory factory;
...
//\II== INSTANCE INITIALIZERS (CONSTRUCTORS) ===================================
     ...
     * @param factory Tovární objekt schopný dodat klíčové objekty
     *                testované aplikace
     */
    protected ATestVisitor(ASolutionTester myTest, IGameFactory factory)
    {
        this.myTest  = myTest;
        this.factory = factory;

        IGame iGame;
        try                 { iGame = factory.game(); }
...
//\IG== INSTANCE GETTERS AND SETTERS ===========================================
     ...
     */
    public final void setScenario(IScenario scenario)
    {
...
//\IM== INSTANCE REMAINING NON-PRIVATE METHODS =================================
     ...
     */
    public void afterGameStart(IScenario scenario)
    {
    }
