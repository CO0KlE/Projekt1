...
//\CC== CLASS CONSTANTS (CONSTANT CLASS/STATIC ATTRIBUTES/FIELDS) ==============
    ...
    private static final String[] DEFAULT_TESTING_SCENARIO_NAMES =
                                { IScenario.HAPPY_NAME,
                                  IScenario.HAPPY_NAME,
                                  IScenario.MISTAKE_NAME,
                                  IScenario.MISTAKE_NS_NAME };
...
//\IC== INSTANCE CONSTANTS (CONSTANT INSTANCE ATTRIBUTES/FIELDS) ===============
    ...
    protected final BiFunction<ASolutionTester, IGameFactory,
...
//                              BiFunction<ASolutionTester, IGameFactory,
//                                         ATestVisitor> visitorFactory,
...
//\IG== INSTANCE GETTERS AND SETTERS ===========================================
     ...
     */
    public List<IScenario> getScenarios(IGameFactory factory)
    {
        List<IScenario> result;
        result = testingScenarioNames
                .stream()
                .map(name -> factory.scenario(name))
     ...
     */
    public ATestVisitor getVisitor(IGameFactory factory)
    {
...
//        JFrame frame = new JFrame(id + " – Solution description");
     ...
     */
    final
    public void test(Class<? extends IGameFactory> factoryClass)
    {
        IGameFactory factory = IGameFactory.getInstanceOfFactory(factoryClass);
        test(factory);
    }
     ...
     */
    public void test(IGameFactory factory)
    {
...
//\IP== INSTANCE PRIVATE AND AUXILIARY METHODS =================================
              ...
              implements IGameFactory
    {
        ...
        @Override public IScenario scenario(String name) { return null; }
        @Override public IScenario scenario(int index)    { return null; }
        @Override public List<? extends IScenario> scenarios() {return null;}
    }
    public static final IGameFactory NOTHING = new MockFactory();
