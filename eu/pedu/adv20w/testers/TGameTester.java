...
//\IC== INSTANCE CONSTANTS (CONSTANT INSTANCE ATTRIBUTES/FIELDS) ===============
    ...
    protected final List<IScenario> testingScenarios;
...
//\II== INSTANCE INITIALIZERS (CONSTRUCTORS) ===================================
     ...
     */
    public TGameTester(ASolutionTester solutionTester, IGameFactory gsmFactory)
    {
        super(gsmFactory);
...
//\IM== INSTANCE REMAINING NON-PRIVATE METHODS =================================
    ...
    {
        GameSummary gameSummary = new GameSummary(solutionTester, factory);
        ...
        for (IScenario scenario : testingScenarios) {
